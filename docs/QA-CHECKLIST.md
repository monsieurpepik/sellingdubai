...
- [ ] **URL:** `https://www.sellingdubai.ae/join`
...
- [ ] **URL:** `https://www.sellingdubai.ae/join` (after Step 1 passes)
...
- [ ] **URL:** `https://www.sellingdubai.ae/join` (OTP step)
...
- [ ] **URL:** `https://www.sellingdubai.ae/join` (Step 3)
...
- [ ] **URL:** `https://www.sellingdubai.ae/dashboard.html` (no token in localStorage)
...
- [ ] **URL:** `https://www.sellingdubai.ae/dashboard.html` (logged in as a fresh agent)
...
- [ ] **URL:** `https://www.sellingdubai.ae/dashboard.html`
...
- [ ] **URL:** `https://www.sellingdubai.ae/join` at 390px
...
- [ ] **URL:** `https://www.sellingdubai.ae/dashboard.html` at 390px
...
- [ ] **URL:** `https://www.sellingdubai.ae/pricing.html`
...
- [ ] **URL:** `https://www.sellingdubai.ae/pricing.html` (logged-in agent already on `pro`)
