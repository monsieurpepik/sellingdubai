...
function injectMortgageSuccessCta(payload: MortPayload) {
  ...
  const loanAmt    = (_mortState.data.loanAmt as number | undefined) ?? 0;
  const totalInt   = (_mortState.data.totalInterest as number | undefined) ?? 0;
